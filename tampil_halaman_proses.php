...
?>
    <!-- Cards -->
    <div class="container">
        <h4 class="text-uppercase font-weight-bold text-secondary mt-2">daftar pengaduan yang sedang diperoses</h4>
        <hr>
        <div class="card bg-primary mr-3" style="width: 100%;">
            <div class="card-body">
                <h5 class="card-title text-uppercase ml-5 mt-3 text-white">Pengaduan Diperoses</h5>
                <div class="display-4 font-weight-bold pt-4 ml-5 mb-3 text-white"><?php echo $jml_pros_all; ?></div>
            </div>
        </div>
        <hr>
        ...
        <table class="table table-striped mt-5 table-hover data">
            ...
            <tbody>
                <?php
                $no = 1;
                while ($data = mysqli_fetch_array($eksekusi_pros_all)) {
                ?>
                    <tr>
